        ...
        <div style={{background: `linear-gradient(0deg, rgb(13,27,40), rgba(255, 0, 150, 0.3)), url(${headerImg})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover'}}  className="" >
           ...
           <div className="flex flex-col max-w-md md:max-w-4xl lg:max-w-6xl py-10 justify-center px-2 mx-auto">
            <div className="md:w-[40vw] text-center md:text-left space-y-3">
                ...
                <p className="text-slate-300 pb-3 ">Step into a world where technology and gaming collide in the most electrifying way possible. Our event management services bring you the future of entertainment, featuring cutting-edge tech showcases and immersive gaming experiences. Get ready to level up your event game with us!</p>
                <Link to="/login">
                    <button className="btn rounded-md bg-gradient-to-r from-red-500  to-cyan-400 border-none shadow-md font-bold">Get Started</button>
                </Link>
            </div>
           </div>
